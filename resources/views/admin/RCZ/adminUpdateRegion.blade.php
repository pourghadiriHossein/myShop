                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="{{ route('adminPostupdateRegion',$region->id) }}"
                                ...
                                <fieldset title="اطلاعات پایه" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input value="{{ $region->label }}" type="text" required="required"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <select name="status" class="form-control" style="height: 40px">
                                                <option value="0" @if($region->status == 0) selected @endif>غیر فعال
                                                </option>
                                                <option value="1" @if($region->status == 1) selected @endif>فعال
                                                </option>
                                            </select>
                                        </div>
                                    </div>
