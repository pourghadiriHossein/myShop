    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">ویرایش ناحیه
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="{{ route('adminPostUpdateZone',$zone->id) }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <fieldset title="اطلاعات پایه" class="step" id="default-step-0">
                                    <legend></legend>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">نام ناحیه</label>
                                        <div class="col-lg-10">
                                            <input value="{{ $zone->label }}" type="text" required="required" oninvalid="this.setCustomValidity('نمیتواند خالی باشد')"
                                                   onchange="this.setCustomValidity('')" name="label" class="form-control" placeholder="نام دسته">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">وضعیت ناحیه</label>
                                        <div class="col-lg-10">
                                            <select name="status" class="form-control" style="height: 40px">
                                                <option value="0" @if($zone->status == 0) selected @endif>غیر فعال</option>
                                                <option value="1" @if($zone->status == 1) selected @endif>فعال</option>
                                            </select>
                                        </div>
                                    </div>
