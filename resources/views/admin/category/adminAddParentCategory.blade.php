                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="{{ route('adminPostAddParentCategory',$parent->id) }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <fieldset title="اطلاعات پایه" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input disabled type="text" required="required" oninvalid="this.setCustomValidity('نمیتواند خالی باشد')"
                                                   onchange="this.setCustomValidity('')" name="firstName" class="form-control" placeholder="{{ $parent->label }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
