                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="{{ route('adminPostUpdateComment',$comment->id) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <select name="status" class="form-control" style="height: 40px">
                                                <option value="0" @if($comment->status == 0) selected @endif>غیر فعال
                                                </option>
                                                <option value="1" @if($comment->status == 1) selected @endif>فعال
                                                </option>
                                            </select>
                                        </div>
                                    </div>
