                        ...
                        <table id="orderTable" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($comment->status == 0) <p class="label label-warning">غیر فعال</p> @endif
                                        @if($comment->status == 1) <p class="label label-success">فعال</p> @endif
                                    </td>

                                    <td><a class="label label-warning" href="{{route('adminUpdateComment',$comment->id)}}">ویرایش</a></td>
                                </tr>
                                @endforeach
                            </tbody>
