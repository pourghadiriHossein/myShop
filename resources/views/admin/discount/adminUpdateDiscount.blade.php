                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="{{ route('adminPostUpdateDiscount', $discount->id) }}"
                                ...
                                <fieldset title="اطلاعات پایه" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input value="{{ $discount->label }}" type="text" required="required"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input @if($discount->price != null) value="{{ $discount->price }}"
                                                   @endif type="text" name="price" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input @if($discount->percent != null) value="{{ $discount->percent }}"
                                                   @endif type="text" name="percent" class="form-control"
                                                   placeholder="عنوان تخفیف">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input @if($discount->token != null) value="{{ $discount->token }}"
                                                   @endif type="text" name="token" class="form-control"
                                                   placeholder="عنوان تخفیف">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <select name="status" class="form-control" style="height: 40px">
                                                <option value="0" @if($discount->status == 0) selected @endif>غیر فعال
                                                </option>
                                                <option value="1" @if($discount->status == 1) selected @endif>فعال
                                                </option>
                                            </select>
                                        </div>
                                    </div>
