                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="{{ route('adminPostUpdateDiscount', $discount->id) }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <fieldset title="اطلاعات پایه" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input value="{{ $discount->label }}" type="text" required="required" oninvalid="this.setCustomValidity('نمیتواند خالی باشد')"
                                                   onchange="this.setCustomValidity('')" name="label" class="form-control" placeholder="عنوان تخفیف">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">مبلغ تخفیف</label>
                                        <div class="col-lg-10">
                                            <input @if($discount->price != null) value="{{ $discount->price }}" @endif type="text" name="price" class="form-control" placeholder="عنوان تخفیف">
                                        </div>
                                    </div><div class="form-group">
                                        <label class="col-lg-2 control-label">درصد تخفیف</label>
                                        <div class="col-lg-10">
                                            <input @if($discount->percent != null) value="{{ $discount->percent }}" @endif type="text" name="percent" class="form-control" placeholder="عنوان تخفیف">
                                        </div>
                                    </div><div class="form-group">
                                        <label class="col-lg-2 control-label">توکن تخفیف</label>
                                        <div class="col-lg-10">
                                            <input @if($discount->token != null) value="{{ $discount->token }}" @endif type="text" name="token" class="form-control" placeholder="عنوان تخفیف">
                                        </div>
                                    </div>
