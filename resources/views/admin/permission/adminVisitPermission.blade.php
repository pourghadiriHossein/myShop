                    ...
                    <div   class="col-xs-12 col-sm-12 col-md-12 table-responsive">
                        ...
                        <table id="orderTable" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="label label-danger" data-toggle="modal" href="#myModal{{$permission->id}}">حذف</a>
                                    <a class="label label-success" href="{{route('adminUpdatePermission',$permission->id)}}">ویرایش</a>
                                </td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">حذف  {{$permission->name}}</h4>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{route('adminDeletePermission',$permission->id)}}" class="btn btn-danger" type="button">آری</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
