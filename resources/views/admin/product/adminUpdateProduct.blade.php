                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="{{route('adminPostUpdateProduct',$product->id)}}"
                                ...
                                <fieldset title="اطلاعات پایه" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input value="{{$product->label}}" type="text" required="required"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <select name="status" class="form-control" style="height: 40px">
                                                <option value="0" @if($product->status == 0) selected @endif>غیر فعال
                                                </option>
                                                <option value="1" @if($product->status == 1) selected @endif>فعال
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select name="discount_id" class="form-control" style="height: 40px">
                                                ...
                                                @foreach($discounts as $discount)
                                                    <option value="{{$discount->id}}"
                                                            @if($product->discount_id == $discount->id) selected @endif>{{$discount->label}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select name="category_id" class="form-control" style="height: 40px">
                                                @foreach($categories as $category)
                                                    <option value="{{$category->id}}"
                                                            @if($product->category_id == $category->id) selected @endif>{{$category->label}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-10">
                                            @foreach($tags as $tag)
                                                <label class="access_lvl">
                                                    <input type="checkbox" name="tags[]" @if(in_array($tag->label,$selectedTag)) checked @endif value="{{$tag->id}}"> {{$tag->label}}
                                                </label>
                                                <br/>
                                            @endforeach
                                        </div>
