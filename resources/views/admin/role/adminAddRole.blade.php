                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form">
                                ...
                                <form class="form-horizontal" action="{{route('adminPostAddRole')}}" method="post" data-toggle="validator" id="user-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input value="{{old('name')}}" type="text" required="required" name="name" class="form-control" placeholder="نام نقش">
                                        </div>
                                    </div>
