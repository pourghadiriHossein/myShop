                    ...
                    <div   class="col-xs-12 col-sm-12 col-md-12 table-responsive">
                        ...
                        <table id="orderTable" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>{{ $tag->label }}</td>
                                <td>
                                    @if($tag->status == 0)<p class="label label-warning" style="width: 250px">غیر فعال</p>@endif
                                    @if($tag->status == 1)<p class="label label-success" style="width: 250px">فعال</p>@endif
                                </td>
                                <td>
                                    <a class="label label-warning" href="{{route('adminUpdateTag',$tag->id)}}">ویرایش</a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
