<section class="section">
    <div class="container container-vertical-middle">
        <div class="row vertical-middle">
            <div class="col-md-3">
                <h2 class="text-left element-top-20 element-bottom-20 text-normal os-animation normal default" data-os-animation="fadeIn" data-os-animation-delay="0s">آخرین محصولات</h2> </div>
            <div class="col-md-9">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="woocommerce columns-4">
                    <div class="row">
                        <ul class="products">
                            @foreach(\App\Models\Tool::getAtLeastProducts() as $product)
                                    ...
                                    <a href="{{route('singleProduct',[$product->id,\App\Models\Tool::readyToUrl($product->label)])}}">
                                        <div class="product-image">
                                            <div class="product-image-front">
                                                <img alt="skirt4-1" height="893" src="@if($product->productImages[0]){{asset($product->productImages[0]->path)}}@endif" width="700">
                                            </div>
                                            <div class="product-image-back"><img alt="skirt4-1" src="@if($product->productImages[1]){{asset($product->productImages[1]->path)}}@endif"></div>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h3 class="price">
                                            @if($product->discount_id)
                                                ...
                                                <ins>
                                                    <span class="amount">
                                                        {{\App\Models\Tool::calculateDiscount($product->price,$product->discount->price,$product->discount->percent)}}                                                        ریال
                                                    </span>
                                                </ins>
                                            @else
                                                <ins>
                                        ...
                                        <a class="add-to-cart-button" href="{{route('session',[$product->id,1,'add'])}}" rel="nofollow"> <i class="icon-bag"></i> </a>
                                    </div>
                            </li>
                            @endforeach
                        </ul>
