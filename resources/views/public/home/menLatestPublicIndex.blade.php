<section class="section">
    <div class="container container-vertical-middle">
        <div class="row vertical-middle">
            <div class="col-md-3">
                <h2 class="text-left element-top-20 element-bottom-20 os-animation normal" data-os-animation="fadeIn" data-os-animation-delay="0s">آخرین محصولات مردانه</h2> </div>
            <div class="col-md-9">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="woocommerce columns-6">
                    <div class="row">
                        <ul class="products">
                            @foreach(\App\Models\Tool::getMenProducts() as $product)
